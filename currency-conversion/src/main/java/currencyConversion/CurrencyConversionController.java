...
public class CurrencyConversionController {
	...
	public ResponseEntity<?> getCurrencyConversion(@PathVariable String from, @PathVariable String to, @PathVariable double quantity, @RequestHeader("Authorization") String authorizationHeader) {
	    try {
	        ...
	        if ("USER".equals(role)) {
	            ...
	            if (possible) {
	                ...
	                BigDecimal result = responseBody.getConversionMultiple().multiply(bigDecimalValue);
	            ...
	            String errorMessage = "Korisnik koji nije User ne može izvršiti razmenu.";
